...
module.exports = do ->
  ...
  class RowView extends BaseRowView
    _expandedRender: ->
      ...
      hiddenFields = ['label', 'hint', 'type', 'select_from_list_name', 'kobo--matrix_list', 'parameters', 'tags', 'bind::oc:contactdata', 'instance::oc:contactdata', 'instance::oc:identifier']
