            ...
            steps {
                script {
                    sh """
                        ...
                        docker buildx create --name multiarchbuilder --node amd64 --platform linux/amd64 --driver docker-container --driver-opt env.BUILDKIT_STEP_LOG_MAX_SIZE=10000000 --driver-opt env.BUILDKIT_STEP_LOG_MAX_SPEED=10000000
                        docker buildx create --name multiarchbuilder --append --node aarch64 --platform linux/arm64,linux/aarch64 tcp://127.0.0.1:1337 --driver docker-container --driver-opt env.BUILDKIT_STEP_LOG_MAX_SIZE=10000000 --driver-opt env.BUILDKIT_STEP_LOG_MAX_SPEED=10000000
