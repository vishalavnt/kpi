            ...
            steps {
                script {
                    sh """
                        ...
                        docker buildx create --name multiarchbuilder --append --node amd64 --platform linux/amd64 --driver-opt env.BUILDKIT_STEP_LOG_MAX_SIZE=10000000 --driver-opt env.BUILDKIT_STEP_LOG_MAX_SPEED=10000000
